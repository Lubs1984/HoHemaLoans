...
CREATE TABLE IF NOT EXISTS "LoanApplications" (
    ...
    "ChannelOrigin" varchar(20) NOT NULL DEFAULT 'Web',
    "WhatsAppSessionId" varchar(100),
    "WhatsAppInitiatedDate" timestamptz,
    "WebInitiatedDate" timestamptz,
    "StepData" jsonb,
    "IsAffordabilityIncluded" boolean NOT NULL DEFAULT false,
    "BankName" varchar(20),
